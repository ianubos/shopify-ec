...
export const API_URL = `https://${STORE_DOMAIN}/api/2021-10/graphql.json`

export const API_TOKEN = process.env.NEXT_PUBLIC_SHOPIFY_STORE_FRONT_ACCESS_TOKEN

// export const LOCAL_STORAGE_NAME = process.env.NEXT_PUBLIC_LOCAL_STORAGE_NAME