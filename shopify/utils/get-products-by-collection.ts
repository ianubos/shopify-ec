 ...
 */
 ...
 async function getProductsByCollection(collectionId: string | number): Promise<Product[]> {
     const products = await fetcher({ query: getCollectionProductsQuery, variables: { collectionId } })
         .then(res => {
